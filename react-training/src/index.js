...
root.render(
  <React.StrictMode>
    ...
    <UserCard
      ...
      avatarURL={
        "https://upload.wikimedia.org/wikipedia/commons/a/ac/NewTux.png"
      }
    />
    <UserCard
      name={"Tarun"}
    ...
    <UserCard
      ...
      avatarURL={
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwxVdJ8MFiC6hxzr1TAcovtKJKvoZrGZAnyC36-v1XRA&s"
      }
    />
    <Weather temp={"29"} />
    <Counter />
